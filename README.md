...
1. Download [Prebuilt Binary](https://github.com/lomkju/oauth2_proxy/releases) (current release is `v2.2`) or build with `$ go get github.com/lomkju/oauth2_proxy` which will put the binary in `$GOROOT/bin`
